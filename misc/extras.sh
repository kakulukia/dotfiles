#!/usr/bin/env zsh
yarn global add iponmap # see your ip on a map
yarn global add carbon-now-cli # create nice code screenshots https://github.com/mixn/carbon-now-cli
yarn global add mapscii # its just awesome that stuff like this is possible!
yarn global add rename-cli # https://github.com/jhotmann/node-rename-cli
...
sudo gem install colorls # better directory listing https://github.com/athityakumar/colorls/
